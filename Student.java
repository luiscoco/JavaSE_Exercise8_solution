...
public class Student extends Person {
    ...
    public void markAttendance(Course course, Date date) {
        List<Date> courseAttendance = attendance.getOrDefault(course, new ArrayList<>());
    ...
    public List<Date> getAttendance(Course course) {
        return attendance.getOrDefault(course, new ArrayList<>());
    }
    
    public List<Integer> getGrades(Course course) {
        return grades.getOrDefault(course, new ArrayList<>());
    }
